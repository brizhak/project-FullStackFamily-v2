...
function shoppingListMarkup() {
    if (dataUser.shoppingList.length === 0) {
        
        const markup = `<li><p class="empty-shopping-list-text">
    ...
    <div>
      <picture>
        ...
        shopListEl.innerHTML = markup;
    } else {
        const markup = dataUser.shoppingList.map(book => {
